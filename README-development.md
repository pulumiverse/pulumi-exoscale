...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `exoscale` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-exoscale
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-exoscale/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-exoscale/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-exoscale_darwin_amd64_v1
│   └── pulumi-resource-exoscale
├── pulumi-exoscale_darwin_arm64
│   └── pulumi-resource-exoscale
├── pulumi-exoscale_linux_amd64_v1
│   └── pulumi-resource-exoscale
├── pulumi-exoscale_linux_arm64
│   └── pulumi-resource-exoscale
├── pulumi-exoscale_windows_amd64_v1
│   └── pulumi-resource-exoscale.exe
└── pulumi-exoscale_windows_arm64
    └── pulumi-resource-exoscale.exe
```
