...
def get_anti_affinity_group(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The anti-affinity group ID to match (conflicts with `name`).
    :param _builtins.str name: The group name to match (conflicts with `id`).
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_anti_affinity_group_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
