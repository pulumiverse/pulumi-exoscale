...
class IamRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A free-form text describing the IAM Role
        :param pulumi.Input[_builtins.bool] editable: Defines if IAM Role Policy is editable or not.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: IAM Role labels.
        :param pulumi.Input[_builtins.str] name: ❗Name of IAM Role.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] permissions: IAM Role permissions.
