...
class SshKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] public_key: ❗ The SSH *public* key that will be authorized in compute instances.
...
class _SshKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] fingerprint: The SSH key unique identifier.
        :param pulumi.Input[_builtins.str] name: ❗ The SSH key name.
        :param pulumi.Input[_builtins.str] public_key: ❗ The SSH *public* key that will be authorized in compute instances.
        """
