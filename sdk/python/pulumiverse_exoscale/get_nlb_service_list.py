...
class GetNlbServiceListResult:
    ...
    def nlb_id(self) -> Optional[_builtins.str]:
        """
    ...
    def nlb_name(self) -> Optional[_builtins.str]:
        """
...
def get_nlb_service_list(nlb_id: Optional[_builtins.str] = None,
                         nlb_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str nlb_id: The NLB ID to match (conflicts with `name`).
    :param _builtins.str nlb_name: The NLB name to match (conflicts with `id`).
...
def get_nlb_service_list_output(nlb_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                nlb_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
