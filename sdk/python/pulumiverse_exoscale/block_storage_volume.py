...
class BlockStorageVolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] size: Volume size in GB (default 10). If volume is attached, instance must be stopped to update this value. Volume can only grow, cannot be shrunk.
...
class _BlockStorageVolumeState:
    def __init__(__self__, *,
                 blocksize: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.int] blocksize: Volume block size.
        :param pulumi.Input[_builtins.str] created_at: Volume creation date.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Resource labels.
        :param pulumi.Input[_builtins.str] name: Volume name.
        :param pulumi.Input[_builtins.int] size: Volume size in GB (default 10). If volume is attached, instance must be stopped to update this value. Volume can only grow, cannot be shrunk.
        :param pulumi.Input['BlockStorageVolumeSnapshotTargetArgs'] snapshot_target: Block storage snapshot to use when creating a volume. Read-only after creation.
        :param pulumi.Input[_builtins.str] state: Volume state.
        :param pulumi.Input[_builtins.str] zone: ❗ The Exoscale [Zone](https://www.exoscale.com/datacenters/) name.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def blocksize(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Volume block size.
        """
    ...
    @blocksize.setter
    def blocksize(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class BlockStorageVolume(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[_builtins.str]] = None,
            timeouts: Optional[pulumi.Input[Union['BlockStorageVolumeTimeoutsArgs', 'BlockStorageVolumeTimeoutsArgsDict']]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'BlockStorageVolume':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def blocksize(self) -> pulumi.Output[_builtins.int]:
        """
        Volume block size.
        """
        return pulumi.get(self, "blocksize")
