...
class NlbArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A free-form text describing the NLB.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A map of key/value labels.
        :param pulumi.Input[_builtins.str] name: The network load balancer (NLB) name.
        """
...
class _NlbState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_at: The NLB creation date.
        :param pulumi.Input[_builtins.str] description: A free-form text describing the NLB.
        :param pulumi.Input[_builtins.str] ip_address: The NLB IPv4 address.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A map of key/value labels.
        :param pulumi.Input[_builtins.str] name: The network load balancer (NLB) name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] services: The list of the exoscale*nlb*service (names).
        :param pulumi.Input[_builtins.str] state: The current NLB state.
        :param pulumi.Input[_builtins.str] zone: ❗ The Exoscale [Zone](https://www.exoscale.com/datacenters/) name.
        """
...
class Nlb(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            services: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            state: Optional[pulumi.Input[_builtins.str]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'Nlb':
        """
