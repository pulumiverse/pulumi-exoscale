...
class DbaasArgs:
    def __init__(__self__, *,
                 ...
                 redis: Optional[pulumi.Input['DbaasRedisArgs']] = None,
        ...
        :param pulumi.Input['DbaasRedisArgs'] redis: *redis* database service type specific arguments. Structure is documented below.
    ...
    @property
    @pulumi.getter
    def redis(self) -> Optional[pulumi.Input['DbaasRedisArgs']]:
        """
    ...
    @redis.setter
    def redis(self, value: Optional[pulumi.Input['DbaasRedisArgs']]):
...
class Dbaas(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 plan: Optional[pulumi.Input[builtins.str]] = None,
                 redis: Optional[pulumi.Input[Union['DbaasRedisArgs', 'DbaasRedisArgsDict']]] = None,
                 termination_protection: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] plan: The plan of the database service (use the [Exoscale CLI](https://github.com/exoscale/cli/) - `exo dbaas type show <TYPE> --plans` - for reference).
        :param pulumi.Input[Union['DbaasRedisArgs', 'DbaasRedisArgsDict']] redis: *redis* database service type specific arguments. Structure is documented below.
        :param pulumi.Input[builtins.bool] termination_protection: The database service protection boolean flag against termination/power-off.
        :param pulumi.Input[builtins.str] type: ❗ The type of the database service (`kafka`, `mysql`, `opensearch`, `pg`, `redis`, `valkey`, `grafana`).
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            valkey: Optional[pulumi.Input[Union['DbaasValkeyArgs', 'DbaasValkeyArgsDict']]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Dbaas':
        """
    ...
    @property
    @pulumi.getter
    def redis(self) -> pulumi.Output[Optional['outputs.DbaasRedis']]:
        """
        *redis* database service type specific arguments. Structure is documented below.
        """
        return pulumi.get(self, "redis")
