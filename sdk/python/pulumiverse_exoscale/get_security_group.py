...
class GetSecurityGroupResult:
    ...
    def external_sources(self) -> Sequence[_builtins.str]:
        """
...
def get_security_group(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The security group ID to match (conflicts with `name`)
    :param _builtins.str name: The name to match (conflicts with `id`)
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
