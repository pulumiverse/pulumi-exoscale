...
class DbaasMysqlUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] authentication: ❗ Authentication details. The possible values are `null`, `caching_sha2_password` and `mysql_native_password`.
        """
...
class DbaasMysqlUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'DbaasMysqlUser':
        """
