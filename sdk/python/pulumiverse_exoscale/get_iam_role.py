...
def get_iam_role(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The role ID to match (conflicts with `name`).
    :param _builtins.str name: the role name to match (conflicts with `id`).
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_iam_role_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
