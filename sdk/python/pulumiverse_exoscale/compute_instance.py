...
class ComputeInstanceArgs:
    def __init__(__self__, *,
                 ...
                 anti_affinity_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 block_storage_volume_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 deploy_target_id: Optional[pulumi.Input[_builtins.str]] = None,
                 destroy_protected: Optional[pulumi.Input[_builtins.bool]] = None,
                 elastic_ip_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.int] disk_size: The instance disk size (GiB; at least `10`). Can not be decreased after creation. **WARNING**: updating this attribute stops/restarts the instance.
        :param pulumi.Input[_builtins.str] template_id: ❗ The get_template (ID) to use when creating the instance.
        :param pulumi.Input[_builtins.str] type: The instance type (`<family>.<size>`, e.g. `standard.medium`; use the [Exoscale CLI](https://github.com/exoscale/cli/) - `exo compute instance-type list` - for the list of available types). **WARNING**: updating this attribute stops/restarts the instance.
        :param pulumi.Input[_builtins.str] zone: ❗ The Exoscale [Zone](https://www.exoscale.com/datacenters/) name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] anti_affinity_group_ids: ❗ A list of exoscale*anti*affinity_group (IDs) to attach to the instance (may only be set at creation time).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] block_storage_volume_ids: A list of exoscale*block*storage_volume (ID) to attach to the instance.
        :param pulumi.Input[_builtins.str] deploy_target_id: ❗ A deploy target ID.
        :param pulumi.Input[_builtins.bool] destroy_protected: Mark the instance as protected, the Exoscale API will refuse to delete the instance until the protection is removed (boolean; default: `false`).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] elastic_ip_ids: A list of exoscale*elastic*ip (IDs) to attach to the instance.
        :param pulumi.Input[_builtins.bool] enable_secure_boot: Indicates whether secure boot is enabled on the instance.
        :param pulumi.Input[_builtins.bool] enable_tpm: Indicates whether TPM is enabled on the instance.
        :param pulumi.Input[_builtins.bool] ipv6: Enable IPv6 on the instance (boolean; default: `false`).
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A map of key/value labels.
        :param pulumi.Input[_builtins.str] name: The compute instance name.
        ...
        :param pulumi.Input[_builtins.bool] private: Whether the instance is private (no public IP addresses; default: false)
        :param pulumi.Input[_builtins.str] reverse_dns: Domain name for reverse DNS record.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: A list of exoscale*security*group (IDs) to attach to the instance.
        :param pulumi.Input[_builtins.str] ssh_key: The exoscale*ssh*key (name) to authorize in the instance (may only be set at creation time).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ssh_keys: The list of exoscale*ssh*key (name) to authorize in the instance (may only be set at creation time).
        :param pulumi.Input[_builtins.str] state: The instance state (`running` or `stopped`; default: `running`).
        :param pulumi.Input[_builtins.str] user_data: [cloud-init](https://cloudinit.readthedocs.io/) configuration.
        """
    ...
    def anti_affinity_group_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def anti_affinity_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "anti_affinity_group_ids", value)

    @_builtins.property
    @pulumi.getter(name="blockStorageVolumeIds")
    def block_storage_volume_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def block_storage_volume_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "block_storage_volume_ids", value)

    @_builtins.property
    @pulumi.getter(name="deployTargetId")
    def deploy_target_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        ❗ A deploy target ID.
        """
    ...
    def deploy_target_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "deploy_target_id", value)

    @_builtins.property
    @pulumi.getter(name="destroyProtected")
    def destroy_protected(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def destroy_protected(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "destroy_protected", value)

    @_builtins.property
    @pulumi.getter(name="elasticIpIds")
    def elastic_ip_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def elastic_ip_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class _ComputeInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] anti_affinity_group_ids: ❗ A list of exoscale*anti*affinity_group (IDs) to attach to the instance (may only be set at creation time).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] block_storage_volume_ids: A list of exoscale*block*storage_volume (ID) to attach to the instance.
        :param pulumi.Input[_builtins.str] created_at: The instance creation date.
        :param pulumi.Input[_builtins.str] deploy_target_id: ❗ A deploy target ID.
        :param pulumi.Input[_builtins.bool] destroy_protected: Mark the instance as protected, the Exoscale API will refuse to delete the instance until the protection is removed (boolean; default: `false`).
        :param pulumi.Input[_builtins.int] disk_size: The instance disk size (GiB; at least `10`). Can not be decreased after creation. **WARNING**: updating this attribute stops/restarts the instance.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] elastic_ip_ids: A list of exoscale*elastic*ip (IDs) to attach to the instance.
        ...
        :param pulumi.Input[_builtins.bool] enable_tpm: Indicates whether TPM is enabled on the instance.
        :param pulumi.Input[_builtins.bool] ipv6: Enable IPv6 on the instance (boolean; default: `false`).
        :param pulumi.Input[_builtins.str] ipv6_address: The instance (main network interface) IPv6 address (if enabled).
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A map of key/value labels.
        :param pulumi.Input[_builtins.str] mac_address: MAC address
        :param pulumi.Input[_builtins.str] name: The compute instance name.
        :param pulumi.Input[Sequence[pulumi.Input['ComputeInstanceNetworkInterfaceArgs']]] network_interfaces: Private network interfaces (may be specified multiple times). Structure is documented below.
        :param pulumi.Input[_builtins.bool] private: Whether the instance is private (no public IP addresses; default: false)
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] private_network_ids: A list of private networks (IDs) attached to the instance. Please use the `network_interface.*.network_id` argument instead.
...
class ComputeInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["enable_tpm"] = enable_tpm
    ...
    @_builtins.property
    @pulumi.getter(name="antiAffinityGroupIds")
    def anti_affinity_group_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        ❗ A list of exoscale*anti*affinity_group (IDs) to attach to the instance (may only be set at creation time).
        """
        return pulumi.get(self, "anti_affinity_group_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="blockStorageVolumeIds")
    def block_storage_volume_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A list of exoscale*block*storage_volume (ID) to attach to the instance.
        """
        return pulumi.get(self, "block_storage_volume_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="deployTargetId")
    def deploy_target_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        ❗ A deploy target ID.
        """
        return pulumi.get(self, "deploy_target_id")
    ...
    @_builtins.property
    @pulumi.getter(name="destroyProtected")
    def destroy_protected(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Mark the instance as protected, the Exoscale API will refuse to delete the instance until the protection is removed (boolean; default: `false`).
        """
        return pulumi.get(self, "destroy_protected")
    ...
    @_builtins.property
    @pulumi.getter(name="elasticIpIds")
    def elastic_ip_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A list of exoscale*elastic*ip (IDs) to attach to the instance.
        """
        return pulumi.get(self, "elastic_ip_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="enableTpm")
    def enable_tpm(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Indicates whether TPM is enabled on the instance.
        """
        return pulumi.get(self, "enable_tpm")
    ...
    @pulumi.getter(name="privateNetworkIds")
    @_utilities.deprecated("""Use the network_interface block instead.""")
    def private_network_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        A list of private networks (IDs) attached to the instance. Please use the `network_interface.*.network_id` argument instead.
        """
        return pulumi.get(self, "private_network_ids")
