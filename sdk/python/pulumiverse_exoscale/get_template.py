...
def get_template(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The compute instance template ID to match (conflicts with `name`).
    :param _builtins.str name: The template name to match (conflicts with `id`) (when multiple templates have the same name, the newest one will be returned).
    :param _builtins.str visibility: A template category filter (default: `public`); among: - `public` - official Exoscale templates - `private` - custom templates private to my organization
