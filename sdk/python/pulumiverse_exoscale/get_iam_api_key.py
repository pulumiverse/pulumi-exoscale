...
def get_iam_api_key(key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str key: The IAM API Key to match.
    """
    __args__ = dict()
    __args__['key'] = key
...
def get_iam_api_key_output(key: Optional[pulumi.Input[_builtins.str]] = None,
