...
def get_sos_bucket_policy(bucket: Optional[_builtins.str] = None,
    ...
    :param _builtins.str bucket: The name of the bucket to which the policy is to be applied.
...
def get_sos_bucket_policy_output(bucket: Optional[pulumi.Input[_builtins.str]] = None,
