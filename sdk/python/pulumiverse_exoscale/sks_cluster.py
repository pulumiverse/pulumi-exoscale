...
class SksClusterArgs:
    def __init__(__self__, *,
                 ...
                 addons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 audit: Optional[pulumi.Input['SksClusterAuditArgs']] = None,
                 auto_upgrade: Optional[pulumi.Input[_builtins.bool]] = None,
                 cni: Optional[pulumi.Input[_builtins.str]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 enable_kube_proxy: Optional[pulumi.Input[_builtins.bool]] = None,
                 exoscale_ccm: Optional[pulumi.Input[_builtins.bool]] = None,
                 exoscale_csi: Optional[pulumi.Input[_builtins.bool]] = None,
                 feature_gates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 metrics_server: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input['SksClusterAuditArgs'] audit: Parameters for Kubernetes Audit configuration (may only be enabled at creation time)
        :param pulumi.Input[_builtins.bool] auto_upgrade: Enable automatic upgrading of the control plane version.
        :param pulumi.Input[_builtins.str] cni: The CNI plugin that is to be used. Available options are "calico" or "cilium". Defaults to "calico". Setting empty string will result in a cluster with no CNI.
        :param pulumi.Input[_builtins.str] description: A free-form text describing the cluster.
        :param pulumi.Input[_builtins.bool] enable_kube_proxy: ❗ Indicates whether to deploy the Kubernetes network proxy. (may only be set at creation time)
        :param pulumi.Input[_builtins.bool] exoscale_ccm: Deploy the Exoscale [Cloud Controller Manager](https://github.com/exoscale/exoscale-cloud-controller-manager/) in the control plane (boolean; default: `true`; may only be set at creation time).
        :param pulumi.Input[_builtins.bool] exoscale_csi: Deploy the Exoscale [Container Storage Interface](https://github.com/exoscale/exoscale-csi-driver/) on worker nodes (boolean; default: `false`; requires the CCM to be enabled).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] feature_gates: Feature gates options for the cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A map of key/value labels.
        :param pulumi.Input[_builtins.bool] metrics_server: Deploy the [Kubernetes Metrics Server](https://github.com/kubernetes-sigs/metrics-server/) in the control plane (boolean; default: `true`; may only be set at creation time).
        :param pulumi.Input[_builtins.str] name: The SKS cluster name.
        ...
        :param pulumi.Input[_builtins.str] service_level: The service level of the control plane (`pro` or `starter`; default: `pro`; may only be set at creation time).
        :param pulumi.Input[_builtins.str] version: The version of the control plane (default: latest version available from the API; see `exo compute sks versions` for reference; may only be set at creation time).
        """
    ...
    def addons(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        return pulumi.get(self, "addons")

    @addons.setter
    def addons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "addons", value)

    @_builtins.property
    @pulumi.getter
    def audit(self) -> Optional[pulumi.Input['SksClusterAuditArgs']]:
        """
    ...
    @audit.setter
    def audit(self, value: Optional[pulumi.Input['SksClusterAuditArgs']]):
    ...
    def enable_kube_proxy(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def enable_kube_proxy(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "enable_kube_proxy", value)

    @_builtins.property
    @pulumi.getter(name="exoscaleCcm")
    def exoscale_ccm(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @exoscale_ccm.setter
    def exoscale_ccm(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "exoscale_ccm", value)

    @_builtins.property
    @pulumi.getter(name="exoscaleCsi")
    def exoscale_csi(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @exoscale_csi.setter
    def exoscale_csi(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def metrics_server(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def metrics_server(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class _SksClusterState:
    def __init__(__self__, *,
                 addons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 aggregation_ca: Optional[pulumi.Input[_builtins.str]] = None,
                 audit: Optional[pulumi.Input['SksClusterAuditArgs']] = None,
                 auto_upgrade: Optional[pulumi.Input[_builtins.bool]] = None,
                 cni: Optional[pulumi.Input[_builtins.str]] = None,
                 control_plane_ca: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 exoscale_csi: Optional[pulumi.Input[_builtins.bool]] = None,
                 feature_gates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 kubelet_ca: Optional[pulumi.Input[_builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 metrics_server: Optional[pulumi.Input[_builtins.bool]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 nodepools: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 oidc: Optional[pulumi.Input['SksClusterOidcArgs']] = None,
                 service_level: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] aggregation_ca: The CA certificate (in PEM format) for TLS communications between the control plane and the aggregation layer (e.g. `metrics-server`).
        :param pulumi.Input['SksClusterAuditArgs'] audit: Parameters for Kubernetes Audit configuration (may only be enabled at creation time)
        :param pulumi.Input[_builtins.bool] auto_upgrade: Enable automatic upgrading of the control plane version.
        :param pulumi.Input[_builtins.str] cni: The CNI plugin that is to be used. Available options are "calico" or "cilium". Defaults to "calico". Setting empty string will result in a cluster with no CNI.
        :param pulumi.Input[_builtins.str] control_plane_ca: The CA certificate (in PEM format) for TLS communications between control plane components.
        :param pulumi.Input[_builtins.str] created_at: The cluster creation date.
        :param pulumi.Input[_builtins.str] description: A free-form text describing the cluster.
        :param pulumi.Input[_builtins.bool] enable_kube_proxy: ❗ Indicates whether to deploy the Kubernetes network proxy. (may only be set at creation time)
        ...
        :param pulumi.Input[_builtins.bool] exoscale_csi: Deploy the Exoscale [Container Storage Interface](https://github.com/exoscale/exoscale-csi-driver/) on worker nodes (boolean; default: `false`; requires the CCM to be enabled).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] feature_gates: Feature gates options for the cluster.
        :param pulumi.Input[_builtins.str] kubelet_ca: The CA certificate (in PEM format) for TLS communications between kubelets and the control plane.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A map of key/value labels.
        :param pulumi.Input[_builtins.bool] metrics_server: Deploy the [Kubernetes Metrics Server](https://github.com/kubernetes-sigs/metrics-server/) in the control plane (boolean; default: `true`; may only be set at creation time).
        :param pulumi.Input[_builtins.str] name: The SKS cluster name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] nodepools: The list of exoscale*sks*nodepool (IDs) attached to the cluster.
        :param pulumi.Input['SksClusterOidcArgs'] oidc: An OpenID Connect configuration to provide to the Kubernetes API server (may only be set at creation time). Structure is documented below.
        :param pulumi.Input[_builtins.str] service_level: The service level of the control plane (`pro` or `starter`; default: `pro`; may only be set at creation time).
        :param pulumi.Input[_builtins.str] state: The cluster state.
        :param pulumi.Input[_builtins.str] version: The version of the control plane (default: latest version available from the API; see `exo compute sks versions` for reference; may only be set at creation time).
        :param pulumi.Input[_builtins.str] zone: ❗ The Exoscale [Zone](https://www.exoscale.com/datacenters/) name.
        """
        if addons is not None:
    ...
    def control_plane_ca(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def control_plane_ca(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def kubelet_ca(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @kubelet_ca.setter
    def kubelet_ca(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def nodepools(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @nodepools.setter
    def nodepools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class SksCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 addons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 audit: Optional[pulumi.Input[Union['SksClusterAuditArgs', 'SksClusterAuditArgsDict']]] = None,
                 auto_upgrade: Optional[pulumi.Input[_builtins.bool]] = None,
                 cni: Optional[pulumi.Input[_builtins.str]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 enable_kube_proxy: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[Union['SksClusterAuditArgs', 'SksClusterAuditArgsDict']] audit: Parameters for Kubernetes Audit configuration (may only be enabled at creation time)
        :param pulumi.Input[_builtins.bool] auto_upgrade: Enable automatic upgrading of the control plane version.
        :param pulumi.Input[_builtins.str] cni: The CNI plugin that is to be used. Available options are "calico" or "cilium". Defaults to "calico". Setting empty string will result in a cluster with no CNI.
        :param pulumi.Input[_builtins.str] description: A free-form text describing the cluster.
        :param pulumi.Input[_builtins.bool] enable_kube_proxy: ❗ Indicates whether to deploy the Kubernetes network proxy. (may only be set at creation time)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[_builtins.str]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'SksCluster':
        """
    ...
    @pulumi.getter
    @_utilities.deprecated("""This attribute has been replaced by `exoscale_ccm`/`metrics_server` attributes, it will be removed in a future release.""")
    def addons(self) -> pulumi.Output[Sequence[_builtins.str]]:
        return pulumi.get(self, "addons")

    @_builtins.property
    @pulumi.getter(name="aggregationCa")
    def aggregation_ca(self) -> pulumi.Output[_builtins.str]:
        """
        The CA certificate (in PEM format) for TLS communications between the control plane and the aggregation layer (e.g. `metrics-server`).
        """
        return pulumi.get(self, "aggregation_ca")
    ...
    @_builtins.property
    @pulumi.getter
    def audit(self) -> pulumi.Output[Optional['outputs.SksClusterAudit']]:
        """
        Parameters for Kubernetes Audit configuration (may only be enabled at creation time)
        """
        return pulumi.get(self, "audit")
    ...
    @_builtins.property
    @pulumi.getter
    def cni(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The CNI plugin that is to be used. Available options are "calico" or "cilium". Defaults to "calico". Setting empty string will result in a cluster with no CNI.
        """
        return pulumi.get(self, "cni")
    ...
    @_builtins.property
    @pulumi.getter(name="controlPlaneCa")
    def control_plane_ca(self) -> pulumi.Output[_builtins.str]:
        """
        The CA certificate (in PEM format) for TLS communications between control plane components.
        """
        return pulumi.get(self, "control_plane_ca")
    ...
    @_builtins.property
    @pulumi.getter(name="enableKubeProxy")
    def enable_kube_proxy(self) -> pulumi.Output[_builtins.bool]:
        """
        ❗ Indicates whether to deploy the Kubernetes network proxy. (may only be set at creation time)
        """
        return pulumi.get(self, "enable_kube_proxy")
    ...
    @_builtins.property
    @pulumi.getter(name="exoscaleCcm")
    def exoscale_ccm(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Deploy the Exoscale [Cloud Controller Manager](https://github.com/exoscale/exoscale-cloud-controller-manager/) in the control plane (boolean; default: `true`; may only be set at creation time).
        """
        return pulumi.get(self, "exoscale_ccm")
    ...
    @_builtins.property
    @pulumi.getter(name="exoscaleCsi")
    def exoscale_csi(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Deploy the Exoscale [Container Storage Interface](https://github.com/exoscale/exoscale-csi-driver/) on worker nodes (boolean; default: `false`; requires the CCM to be enabled).
        """
        return pulumi.get(self, "exoscale_csi")
    ...
    @_builtins.property
    @pulumi.getter(name="kubeletCa")
    def kubelet_ca(self) -> pulumi.Output[_builtins.str]:
        """
        The CA certificate (in PEM format) for TLS communications between kubelets and the control plane.
        """
        return pulumi.get(self, "kubelet_ca")
    ...
    @_builtins.property
    @pulumi.getter(name="metricsServer")
    def metrics_server(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Deploy the [Kubernetes Metrics Server](https://github.com/kubernetes-sigs/metrics-server/) in the control plane (boolean; default: `true`; may only be set at creation time).
        """
        return pulumi.get(self, "metrics_server")
    ...
    @_builtins.property
    @pulumi.getter
    def nodepools(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The list of exoscale*sks*nodepool (IDs) attached to the cluster.
        """
        return pulumi.get(self, "nodepools")
