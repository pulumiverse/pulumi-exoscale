...
def get_sks_nodepool(anti_affinity_group_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] anti_affinity_group_ids: A list of exoscale*anti*affinity_group (IDs) to be attached to the managed instances.
    ...
    :param _builtins.str instance_pool_id: The underlying exoscale*instance*pool ID.
    ...
    :param Sequence[_builtins.str] private_network_ids: A list of exoscale*private*network (IDs) to be attached to the managed instances.
    :param Sequence[_builtins.str] security_group_ids: A list of exoscale*security*group (IDs) to be attached to the managed instances.
    ...
    :param Mapping[str, _builtins.str] taints: A map of key/value Kubernetes [taints](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/) ('taints = { \\n\\n = "\\n\\n:\\n\\n" }').
...
def get_sks_nodepool_output(anti_affinity_group_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                            ...
                            private_network_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
