...
def get_block_storage_volume_snapshot(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: Snapshot ID to match.
...
def get_block_storage_volume_snapshot_output(id: Optional[pulumi.Input[_builtins.str]] = None,
