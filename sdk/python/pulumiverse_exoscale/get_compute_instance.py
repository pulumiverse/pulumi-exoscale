...
def get_compute_instance(id: Optional[_builtins.str] = None,
...
def get_compute_instance_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
