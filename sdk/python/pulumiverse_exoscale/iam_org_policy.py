...
class IamOrgPolicyArgs:
    def __init__(__self__, *,
                 default_service_strategy: pulumi.Input[_builtins.str],
    ...
    def default_service_strategy(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def default_service_strategy(self, value: pulumi.Input[_builtins.str]):
...
class IamOrgPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="defaultServiceStrategy")
    def default_service_strategy(self) -> pulumi.Output[_builtins.str]:
        """
        Default service strategy (`allow` or `deny`).
        """
        return pulumi.get(self, "default_service_strategy")
