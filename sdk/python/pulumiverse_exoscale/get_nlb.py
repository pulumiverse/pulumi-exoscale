...
def get_nlb(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The Network Load Balancers (NLB) ID to match (conflicts with `name`).
    :param _builtins.str name: The NLB name to match (conflicts with `id`).
...
def get_nlb_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
