...
class _DbaasKafkaUserState:
    def __init__(__self__, *,
                 ...
                 access_cert_expiry: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] access_cert_expiry: Access certificate expiry date.
    ...
    def access_cert_expiry(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def access_cert_expiry(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class DbaasKafkaUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'DbaasKafkaUser':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="accessCertExpiry")
    def access_cert_expiry(self) -> pulumi.Output[_builtins.str]:
        """
        Access certificate expiry date.
        """
        return pulumi.get(self, "access_cert_expiry")
