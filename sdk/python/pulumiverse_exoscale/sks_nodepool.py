...
class SksNodepoolArgs:
    def __init__(__self__, *,
                 ...
                 storage_lvm: Optional[pulumi.Input[_builtins.bool]] = None,
                 taints: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] anti_affinity_group_ids: A list of exoscale*anti*affinity_group (IDs) to be attached to the managed instances.
        ...
        :param pulumi.Input[_builtins.int] disk_size: The managed instances disk size (GiB; default: `50`).
        :param pulumi.Input[_builtins.str] instance_prefix: The string used to prefix the managed instances name (default `pool`).
        :param pulumi.Input[_builtins.bool] ipv6: Enable IPV6 for the nodepool nodes
        ...
        :param pulumi.Input[_builtins.str] name: The SKS node pool name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] private_network_ids: A list of exoscale*private*network (IDs) to be attached to the managed instances.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: A list of exoscale*security*group (IDs) to be attached to the managed instances.
        :param pulumi.Input[_builtins.bool] storage_lvm: Create nodes with non-standard partitioning for persistent storage (requires min 100G of disk space) (may only be set at creation time).
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] taints: A map of key/value Kubernetes [taints](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/) ('taints = { \\n\\n = "\\n\\n:\\n\\n" }').
        """
    ...
    def storage_lvm(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @storage_lvm.setter
    def storage_lvm(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "storage_lvm", value)

    @_builtins.property
    @pulumi.getter
    def taints(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class _SksNodepoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] anti_affinity_group_ids: A list of exoscale*anti*affinity_group (IDs) to be attached to the managed instances.
        :param pulumi.Input[_builtins.str] cluster_id: ❗ The parent exoscale*sks*cluster ID.
        :param pulumi.Input[_builtins.str] created_at: The pool creation date.
        :param pulumi.Input[_builtins.str] deploy_target_id: A deploy target ID.
        :param pulumi.Input[_builtins.str] description: A free-form text describing the pool.
        :param pulumi.Input[_builtins.int] disk_size: The managed instances disk size (GiB; default: `50`).
        :param pulumi.Input[_builtins.str] instance_pool_id: The underlying exoscale*instance*pool ID.
        :param pulumi.Input[_builtins.str] instance_prefix: The string used to prefix the managed instances name (default `pool`).
        :param pulumi.Input[_builtins.str] instance_type: The managed compute instances type (`<family>.<size>`, e.g. `standard.medium`; use the [Exoscale CLI](https://github.com/exoscale/cli/) - `exo compute instance-type list` - for the list of available types).
        :param pulumi.Input[_builtins.bool] ipv6: Enable IPV6 for the nodepool nodes
        :param pulumi.Input[Sequence[pulumi.Input['SksNodepoolKubeletImageGcArgs']]] kubelet_image_gcs: Configuration for this nodepool's kubelet image garbage collector
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] private_network_ids: A list of exoscale*private*network (IDs) to be attached to the managed instances.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: A list of exoscale*security*group (IDs) to be attached to the managed instances.
        :param pulumi.Input[_builtins.str] state: The current pool state.
        :param pulumi.Input[_builtins.bool] storage_lvm: Create nodes with non-standard partitioning for persistent storage (requires min 100G of disk space) (may only be set at creation time).
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] taints: A map of key/value Kubernetes [taints](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/) ('taints = { \\n\\n = "\\n\\n:\\n\\n" }').
        :param pulumi.Input[_builtins.str] template_id: The managed instances template ID.
        :param pulumi.Input[_builtins.str] version: The managed instances version.
        :param pulumi.Input[_builtins.str] zone: ❗ The Exoscale [Zone](https://www.exoscale.com/datacenters/) name.
        """
        if anti_affinity_group_ids is not None:
            pulumi.set(__self__, "anti_affinity_group_ids", anti_affinity_group_ids)
...
class SksNodepool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template_id: Optional[pulumi.Input[_builtins.str]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'SksNodepool':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="storageLvm")
    def storage_lvm(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Create nodes with non-standard partitioning for persistent storage (requires min 100G of disk space) (may only be set at creation time).
        """
        return pulumi.get(self, "storage_lvm")
    ...
    @_builtins.property
    @pulumi.getter
    def taints(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        A map of key/value Kubernetes [taints](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/) ('taints = { \\n\\n = "\\n\\n:\\n\\n" }').
        """
        return pulumi.get(self, "taints")
