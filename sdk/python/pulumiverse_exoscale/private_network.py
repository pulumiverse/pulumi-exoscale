...
class PrivateNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A free-form text describing the network.
        :param pulumi.Input[_builtins.str] end_ip: (For managed Privnets) The first/last IPv4 addresses used by the DHCP service for dynamic leases.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A map of key/value labels.
        :param pulumi.Input[_builtins.str] name: The private network name.
        :param pulumi.Input[_builtins.str] netmask: (For managed Privnets) The network mask defining the IPv4 network allowed for static leases.
        :param pulumi.Input[_builtins.str] start_ip: (For managed Privnets) The first/last IPv4 addresses used by the DHCP service for dynamic leases.
        """
...
class PrivateNetwork(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="endIp")
    def end_ip(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        (For managed Privnets) The first/last IPv4 addresses used by the DHCP service for dynamic leases.
        """
        return pulumi.get(self, "end_ip")
    ...
    @_builtins.property
    @pulumi.getter
    def netmask(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        (For managed Privnets) The network mask defining the IPv4 network allowed for static leases.
        """
        return pulumi.get(self, "netmask")
    ...
    @_builtins.property
    @pulumi.getter(name="startIp")
    def start_ip(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        (For managed Privnets) The first/last IPv4 addresses used by the DHCP service for dynamic leases.
        """
        return pulumi.get(self, "start_ip")
