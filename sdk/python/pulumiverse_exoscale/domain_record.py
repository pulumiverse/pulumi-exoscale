...
class DomainRecordArgs:
    def __init__(__self__, *,
                 ...
                 prio: Optional[pulumi.Input[_builtins.int]] = None,
                 ttl: Optional[pulumi.Input[_builtins.int]] = None):
        """
        The set of arguments for constructing a DomainRecord resource.
        :param pulumi.Input[_builtins.str] content: The record value. Format follows specific record type. For example SRV record format would be `<weight> <port> <target>`
        :param pulumi.Input[_builtins.str] domain: ❗ The parent Domain to attach the record to.
        :param pulumi.Input[_builtins.str] record_type: ❗ The record type (`A`, `AAAA`, `ALIAS`, `CAA`, `CNAME`, `HINFO`, `MX`, `NAPTR`, `NS`, `POOL`, `SPF`, `SRV`, `SSHFP`, `TXT`, `URL`).
        :param pulumi.Input[_builtins.str] name: The record name, Leave blank (`""`) to create a root record (similar to using `@` in a DNS zone file).
        :param pulumi.Input[_builtins.int] prio: The record priority (for types that support it; minimum `0`).
        :param pulumi.Input[_builtins.int] ttl: The record TTL (seconds; minimum `0`; default: `3600`).
        """
    ...
    @_builtins.property
    @pulumi.getter
    def prio(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @prio.setter
    def prio(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _DomainRecordState:
    def __init__(__self__, *,
                 ...
                 content_normalized: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] content: The record value. Format follows specific record type. For example SRV record format would be `<weight> <port> <target>`
        :param pulumi.Input[_builtins.str] content_normalized: The normalized value of the record
        :param pulumi.Input[_builtins.str] domain: ❗ The parent Domain to attach the record to.
        :param pulumi.Input[_builtins.str] hostname: The record *Fully Qualified Domain Name* (FQDN). Useful for aliasing `A`/`AAAA` records with `CNAME`.
        :param pulumi.Input[_builtins.str] name: The record name, Leave blank (`""`) to create a root record (similar to using `@` in a DNS zone file).
        :param pulumi.Input[_builtins.int] prio: The record priority (for types that support it; minimum `0`).
        :param pulumi.Input[_builtins.str] record_type: ❗ The record type (`A`, `AAAA`, `ALIAS`, `CAA`, `CNAME`, `HINFO`, `MX`, `NAPTR`, `NS`, `POOL`, `SPF`, `SRV`, `SSHFP`, `TXT`, `URL`).
        :param pulumi.Input[_builtins.int] ttl: The record TTL (seconds; minimum `0`; default: `3600`).
    ...
    def content_normalized(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def content_normalized(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class DomainRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            prio: Optional[pulumi.Input[_builtins.int]] = None,
            record_type: Optional[pulumi.Input[_builtins.str]] = None,
            ttl: Optional[pulumi.Input[_builtins.int]] = None) -> 'DomainRecord':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="contentNormalized")
    def content_normalized(self) -> pulumi.Output[_builtins.str]:
        """
        The normalized value of the record
        """
        return pulumi.get(self, "content_normalized")
