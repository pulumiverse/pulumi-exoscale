...
class IamAccessKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: ❗ The IAM access key name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] operations: ❗ A list of API operations to restrict the key to.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources: ❗ A list of API [resources](https://community.exoscale.com/documentation/iam/quick-start/#restricting-api-access-keys-to-resources) to restrict the key to (`<domain>/<type>:<name>`).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: ❗ A list of tags to restrict the key to.
        """
        if name is not None:
...
class _IamAccessKeyState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 tags_operations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering IamAccessKey resources.
        :param pulumi.Input[_builtins.str] key: The IAM access key (identifier).
        :param pulumi.Input[_builtins.str] name: ❗ The IAM access key name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] operations: ❗ A list of API operations to restrict the key to.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources: ❗ A list of API [resources](https://community.exoscale.com/documentation/iam/quick-start/#restricting-api-access-keys-to-resources) to restrict the key to (`<domain>/<type>:<name>`).
        :param pulumi.Input[_builtins.str] secret: The key secret.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: ❗ A list of tags to restrict the key to.
        """
        if key is not None:
    ...
    def tags_operations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        return pulumi.get(self, "tags_operations")

    @tags_operations.setter
    def tags_operations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class IamAccessKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            tags_operations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'IamAccessKey':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="tagsOperations")
    def tags_operations(self) -> pulumi.Output[Sequence[_builtins.str]]:
        return pulumi.get(self, "tags_operations")
