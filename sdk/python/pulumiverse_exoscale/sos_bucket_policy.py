...
class SosBucketPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] bucket: ❗ The name of the bucket to which the policy is to be applied.
        :param pulumi.Input[_builtins.str] policy: The content of the policy
...
class SosBucketPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy: Optional[pulumi.Input[_builtins.str]] = None,
            timeouts: Optional[pulumi.Input[Union['SosBucketPolicyTimeoutsArgs', 'SosBucketPolicyTimeoutsArgsDict']]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'SosBucketPolicy':
        """
