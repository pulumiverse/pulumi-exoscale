...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 sos_endpoint: Optional[pulumi.Input[_builtins.str]] = None,
                 timeout: Optional[pulumi.Input[_builtins.int]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[_builtins.str] key: Exoscale API key
        :param pulumi.Input[_builtins.str] secret: Exoscale API secret
        :param pulumi.Input[_builtins.int] timeout: Timeout in seconds for waiting on compute resources to become available (by default: 3600)
        """
    ...
    def sos_endpoint(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "sos_endpoint")

    @sos_endpoint.setter
    def sos_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @_builtins.property
    @pulumi.getter(name="sosEndpoint")
    def sos_endpoint(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "sos_endpoint")
