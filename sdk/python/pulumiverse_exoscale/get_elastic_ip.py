...
def get_elastic_ip(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The Elastic IP (EIP) ID to match (conflicts with `ip_address` and `labels`).
    :param _builtins.str ip_address: The EIP IPv4 or IPv6 address to match (conflicts with `id` and `labels`).
    :param Mapping[str, _builtins.str] labels: The EIP labels to match (conflicts with `ip_address` and `id`).
    :param _builtins.str zone: The Exocale [Zone](https://www.exoscale.com/datacenters/) name.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_elastic_ip_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
