...
def get_private_network(description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str description: The private network description.
    :param _builtins.str id: The private network ID to match (conflicts with `name`).
    :param Mapping[str, _builtins.str] labels: A map of key/value labels.
    :param _builtins.str name: The network name to match (conflicts with `id`).
...
def get_private_network_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
