...
func GetSksNodepoolListOutput(ctx *pulumi.Context, args GetSksNodepoolListOutputArgs, opts ...pulumi.InvokeOption) GetSksNodepoolListResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSksNodepoolListResultOutput, error) {
			...
			return ctx.InvokeOutput("exoscale:index/getSksNodepoolList:getSksNodepoolList", args, GetSksNodepoolListResultOutput{}, options).(GetSksNodepoolListResultOutput), nil
...
// Match against this bool
func (o GetSksNodepoolListResultOutput) Ipv6() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetSksNodepoolListResult) *bool { return v.Ipv6 }).(pulumi.BoolPtrOutput)
}
