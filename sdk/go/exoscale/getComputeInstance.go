...
func LookupComputeInstanceOutput(ctx *pulumi.Context, args LookupComputeInstanceOutputArgs, opts ...pulumi.InvokeOption) LookupComputeInstanceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupComputeInstanceResultOutput, error) {
			...
			return ctx.InvokeOutput("exoscale:index/getComputeInstance:getComputeInstance", args, LookupComputeInstanceResultOutput{}, options).(LookupComputeInstanceResultOutput), nil
...
// The list of exoscale*ssh*key (name) authorized on the instance.
func (o LookupComputeInstanceResultOutput) SshKeys() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupComputeInstanceResult) []string { return v.SshKeys }).(pulumi.StringArrayOutput)
}
